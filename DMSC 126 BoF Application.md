...
## Links to the mailing list, draft charter if any (for WG-forming BoF), relevant Internet-Drafts, etc.
   ...
   - Relevant Internet-Drafts:
      - Use Cases:
        <ol type="1">
        <li> <a href="https://datatracker.ietf.org/doc/draft-yu-dmsc-ai-agent-use-cases-in-6g/"> AI Agent Use Cases and Requirements in 6G Network </a> </li>
        <li> <a href="https://datatracker.ietf.org/doc/html/draft-tong-network-agent-use-cases-in-6g-00"> Network AI Agent Use Cases and Requirements in 6G </a></li>
      ...
      - Solutions
        ...
        <li> <a href="https://datatracker.ietf.org/doc/draft-sz-dmsc-iaip/)"> Intent-based Agent Interconnection Protocol at Agent Gateway </a> </li>
        <li> <a href="https://datatracker.ietf.org/doc/draft-somoza-dmsc-atn-agent-trust-negotiation/"> Agent Trust Negotiation: Capability, Delegation, and Provenance Binding for AI Agents </a></li>   
        <li> <a href="https://datatracker.ietf.org/doc/draft-zhang-dmsc-mas-communication/"> Security Analysis of Multi-agents Secured Communication and Limitations of Existing Protocols</a> </li>
        <li> <a href="https://datatracker.ietf.org/doc/draft-zhang-dmsc-ioa-semantic-interaction/"> Ontology-based Semantic Interaction for Internet of Agents </a> </li>
        <li> <a href="https://datatracker.ietf.org/doc/draft-cui-dmsc-agent-cdi/"> Cross-Domain Interoperability Framework for AI Agent Collaboration </a> </li>
        <li> <a href="https://datatracker.ietf.org/doc/draft-verma-dmsc-nlip-notes/"> Using Natural Language for Universal Coordination in Multi Agent Systems </a> </li>
        </ol>
